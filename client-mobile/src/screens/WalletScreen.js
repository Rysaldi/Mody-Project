...
import { fetchWallets, addNewWallet, deleteWallet } from "../store/actionCreator/wallet";
			...
			<View style={styles.walletCard}>
				...
				<View style={styles.features}>
					...
					<Pressable
						...
						<Image style={styles.imageIcon} source={require("../../assets/icons/editGreen.png")} />
					</Pressable>
					<Pressable
					...
					<Pressable
						...
						<Image style={styles.imageIcon} source={require("../../assets/icons/red_trash.png")} />
					</Pressable>
				</View>
			</View>
		);
		...
		<View style={styles.container}>
			<View style={styles.formAdd}>
				...
				<View style={styles.formAddWallet}>
					...
					<TextInput value={walletName} onChangeText={setWalletName} style={styles.input} />
				</View>
