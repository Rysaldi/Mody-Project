...
export const SUCCESS_FETCH_CATEGORIES = "categories/successFetchAll"; //udah
export const LOADING_FETCH_CATEGORIES = "categories/loadingFetchAll"; //udah
...
export const LOADING_FETCH_WALLETS = "wallets/loadingFetchAll";

export const SUCCESS_POST_TRANSACTION = "transactions/successPost";
export const LOADING_POST_TRANSACTION = "transactions/loadingPost";

export const SUCCESS_FETCH_DETAIL = "wallets/successFetchDetail";
export const ERROR_FETCH_DETAIL = "wallets/errorFetchDetail";
export const LOADING_FETCH_DETAIL = "wallets/loadingFetchDetail";
...
export const LOADING_USER_LOGIN = "user/loadingUserLogin";

export const USER_LOGOUT = "user/userLogout";
export const LOADING_USER_LOGOUT = "user/loadingUserLogout";

export const USER_HISTORY = "user/history";
export const LOADING_USER_HISTORY = "user/loadingHistory";
...
export const LOADING_UPDATE_PROFILE = "profile/loadingUpdate";
...
export const SUCCESS_DELETE_USER_WALLET = "/userWallet/deleteUserWallet";
