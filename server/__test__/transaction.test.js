...
const access_token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiaWF0IjoxNjYyNjQ0NjQyfQ.7DbeRaoNhylwZeCJCDBcmi0adQT_mt2smI12eFVpKSM";
  ...
  describe("PUT /transactions/:id - Succes test", () => {
    it("should be return an object message success", async () => {
      ...
      expect(response.body.message).toBe(
        "Succes Edit Transaction with Id " + id
      );
    });
  });
...
describe("Delete /transactions/:id", () => {
  describe("Delete /transactions/:id - Succes test", () => {
    it("should return a success message", async () => {
      ...
      expect(response.body).toHaveProperty("message");
      expect(response.body.message).toBe(
        "Success delete Transaction with Id " + id
      );
    });
  });
